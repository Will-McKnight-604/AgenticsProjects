...
<template>
    <CoreCrossReferencer 
        v-if="currentRoute == '/core_cross_referencer_micrometals' || currentRoute == '/core_shape_cross_referencer_micrometals'"
        suffix="_micrometals"
        loadingGif="/images/loading_micrometals.gif"
        :onlyManufacturer="'Micrometals'"
        :keepMaterialConstant="currentRoute == '/core_shape_cross_referencer_micrometals'"
    />
    <CoreMaterialCrossReferencer
        suffix="_micrometals"
        :onlyManufacturer="'Micrometals'"
        loadingGif="/images/loading_micrometals.gif"
        v-if="currentRoute == '/core_material_cross_referencer_micrometals'"
    />
</template>
