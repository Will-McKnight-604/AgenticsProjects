...
<template>
    <CoreCrossReferencer 
        v-if="currentRoute == '/core_cross_referencer_standex' || currentRoute == '/core_shape_cross_referencer_standex'"
        loadingGif="/images/loading_standex.gif"
        :keepMaterialConstant="currentRoute == '/core_shape_cross_referencer_standex'"
    />
    <CoreMaterialCrossReferencer
        loadingGif="/images/loading_standex.gif"
        v-if="currentRoute == '/core_material_cross_referencer_standex'"
    />
</template>
