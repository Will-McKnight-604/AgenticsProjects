...
<template>
    <CoreCrossReferencer 
        v-if="currentRoute == '/core_cross_referencer_ferroxcube' || currentRoute == '/core_shape_cross_referencer_ferroxcube'"
        suffix="_ferroxcube"
        loadingGif="/images/loading_ferroxcube.gif"
        :onlyManufacturer="'Ferroxcube'"
        :keepMaterialConstant="currentRoute == '/core_shape_cross_referencer_ferroxcube'"
    />
    <CoreMaterialCrossReferencer
        suffix="_ferroxcube"
        :onlyManufacturer="'Ferroxcube'"
        loadingGif="/images/loading_ferroxcube.gif"
        v-if="currentRoute == '/core_material_cross_referencer_ferroxcube'"
    />
</template>
