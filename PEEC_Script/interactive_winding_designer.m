...
function build_gui(data)
    ...
    % Core Loss label + method + k/a/b all on one compact row at y=213
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Core Loss:', ...
              'Position', [20 216 68 16], ...
              'FontWeight', 'bold', 'HorizontalAlignment', 'left', ...
              'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Method:', ...
              'Position', [91 216 45 16], ...
              'HorizontalAlignment', 'left', 'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'popupmenu', ...
              'String', loss_methods, ...
              'Position', [138 213 62 22], ...
              'Value', loss_idx, ...
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'a:', ...
              'Position', [276 216 14 16], ...
              'HorizontalAlignment', 'right', 'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', steinmetz_a_str, ...
              'Position', [292 213 42 22], ...
              'Tag', 'steinmetz_alpha', ...
              'FontSize', 8, ...
              'BackgroundColor', steinmetz_bg, ...
              'TooltipString', steinmetz_tip, ...
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'b:', ...
              'Position', [338 216 14 16], ...
              'HorizontalAlignment', 'right', 'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', steinmetz_b_str, ...
              'Position', [354 213 40 22], ...
              'Tag', 'steinmetz_beta', ...
              'FontSize', 8, ...
              'BackgroundColor', steinmetz_bg, ...
              'TooltipString', steinmetz_tip, ...
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              ...
              'Position', [20 190 180 20], ...
              'FontWeight', 'bold', 'HorizontalAlignment', 'left');

    % Gap Type
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Type:', ...
              'Position', [30 168 50 20], ...
              'HorizontalAlignment', 'left');
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Length:', ...
              'Position', [30 143 50 20], ...
              'HorizontalAlignment', 'left');

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', num2str(data.core_gap_length * 1e3), ...
              'Position', [130 143 80 25], ...
              'Tag', 'gap_length', ...
              'Enable', 'off', ...
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'No. Gaps:', ...
              'Position', [260 143 60 20], ...
              'HorizontalAlignment', 'left');

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', num2str(data.core_num_gaps), ...
              'Position', [330 143 60 25], ...
              'Tag', 'gap_num', ...
              'Enable', 'off', ...
              'Callback', @update_num_gaps);

    % Frequency input (y=118)
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Operating Frequency (kHz):', ...
              'Position', [20 121 180 18], ...
              'HorizontalAlignment', 'left');

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', num2str(data.f/1e3), ...
              'Position', [210 118 80 22], ...
              'Tag', 'frequency', ...
              'Callback', @update_frequency);

    % Insulation Standard label bold (y=96, above radio group at y=72)
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Insulation Standard:', ...
              'Position', [20 96 180 18], ...
              'HorizontalAlignment', 'left', 'FontWeight', 'bold', ...
              'FontSize', 9, ...
              'Tag', 'insulation_std_label');

    % Insulation Standard radio button group (pixel coords, y=72)
    insulation_standard_group = uibuttongroup('Parent', core_panel, ...
              'Units', 'pixels', 'Position', [20 72 370 22], ...
              'BorderType', 'none', ...
    ...
    % Insulation Class label + dropdown (y=48)
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Insulation Class:', ...
              'Position', [20 51 120 18], ...
              'HorizontalAlignment', 'left', ...
    ...
    % Edge margin (mm) (y=4, same row as TIW - right side)
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Edge Margin (mm):', ...
              'Position', [130 7 115 18], ...
              'HorizontalAlignment', 'left', ...
              'Tag', 'edge_margin_label');

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', num2str(data.edge_margin * 1e3), ...
              'Position', [248 4 60 22], ...
              'Tag', 'edge_margin', ...
