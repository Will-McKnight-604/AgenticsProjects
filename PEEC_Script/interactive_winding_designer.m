...
function build_gui(data)
    ...
    % --- Core Loss Model (compact single row, placed just above gap config) ---
    ...
    % Core Loss label + method + k/a/b all on one compact row at y=143
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Core Loss:', ...
              'Position', [20 146 68 16], ...
              'FontWeight', 'bold', 'HorizontalAlignment', 'left', ...
              'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'Method:', ...
              'Position', [91 146 45 16], ...
              'HorizontalAlignment', 'left', 'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'popupmenu', ...
              'String', loss_methods, ...
              'Position', [138 143 62 22], ...
              'Value', loss_idx, ...
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'k:', ...
              'Position', [204 146 14 16], ...
              'HorizontalAlignment', 'right', 'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', steinmetz_k_str, ...
              'Position', [220 143 52 22], ...
              'Tag', 'steinmetz_k', ...
              'FontSize', 8, ...
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'a:', ...
              'Position', [276 146 14 16], ...
              'HorizontalAlignment', 'right', 'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', steinmetz_a_str, ...
              'Position', [292 143 42 22], ...
              'Tag', 'steinmetz_alpha', ...
              'FontSize', 8, ...
              'BackgroundColor', steinmetz_bg, ...
              'TooltipString', steinmetz_tip, ...
    ...
    uicontrol('Parent', core_panel, 'Style', 'text', ...
              'String', 'b:', ...
              'Position', [338 146 14 16], ...
              'HorizontalAlignment', 'right', 'FontSize', 8);

    uicontrol('Parent', core_panel, 'Style', 'edit', ...
              'String', steinmetz_b_str, ...
              'Position', [354 143 40 22], ...
              'Tag', 'steinmetz_beta', ...
              'FontSize', 8, ...
              'BackgroundColor', steinmetz_bg, ...
              'TooltipString', steinmetz_tip, ...
...
function run_analysis(src, ~)
    ...
    try
        svg_file_path = fullfile(get_local_script_dir(), 'om_visualization.svg');
